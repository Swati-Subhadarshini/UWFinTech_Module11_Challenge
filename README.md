...
MercadoLibre is the most popular e-commerce site in Latin America. The project is designed to analyze the company's financial and user data in clever ways to make the company grow. So, the model is prepared to predict search traffic can translate into the ability to successfully trade the stock.
